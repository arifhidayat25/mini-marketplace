<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="pb-6 border-b border-gray-200 mb-8">
        <h1 class="text-4xl font-bold text-gray-800">
            Kategori: <span class="text-indigo-600">{{ $category->name }}</span>
        </h1>
        {{-- Anda bisa menambahkan deskripsi kategori di sini jika ada --}}
    </div>
    ...
    @else
        ...
        <div class="text-center py-16 bg-white rounded-lg shadow-md">
            ...
            <p class="text-gray-500 mt-2">Belum ada produk di kategori ini.</p>
        </div>
    @endif
</div>